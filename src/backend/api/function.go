...
// 	CombineFunction(c echo.Context) error
...
// type combineFunctionReq struct {
// 	FuncName  string   `json:"func_name"`
// 	Functions []string `json:"functions"`
// }

// func (f FunctionAPIImpl) CombineFunction(c echo.Context) error {
// 	var body *combineFunctionReq = new(combineFunctionReq)
// 	if err := c.Bind(&body); err != nil {
// 		return c.JSON(http.StatusBadRequest, err)
// 	}

// 	for _, funcName := range body.Functions {
// 		var len int64 = 0
// 		err := f.userDb.Table("functions").
// 			Where("name = ?", funcName).
// 			Count(&len).Error
// 		if err != nil {
// 			return c.JSON(http.StatusInternalServerError, map[string]interface{}{
// 				"error": "Failed to combine function: " + err.Error(),
// 			})
// 		}
// 		if len == 0 {
// 			return c.JSON(http.StatusInternalServerError, map[string]interface{}{
// 				"error": "Failed to combine function: " + funcName + " does not exist",
// 			})
// 		}
// 	}

// 	err := f.appDb.Create(&model.Function{
// 		Name: body.FuncName,
// 		Data: strings.Join(body.Functions, ","),
// 		Type: "multiple",
// 	}).Error
// 	if err != nil {
// 		return c.JSON(http.StatusInternalServerError, map[string]interface{}{
